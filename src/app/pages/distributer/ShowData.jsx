...
const ShowData = (props) => {
    ...
    // this function will get data which a manufacturer send to the particular Distributor 
    const getDistributerData = async (distributerId) => {
        try {
            const result = await axios.post("/api/manufacturerData/distributorData", { distributerId })
            if (Array.isArray(result.data.response)) {
                setDistributerData(result.data.response)
            }
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                getDistributerData(props.distributorId)
        ...
        <>
            <div className="mt-8">
                <div className='flex justify-between items-center p-4'>
                    ...
                    <ButtonPage distributerData={distributerData} />
                </div>
