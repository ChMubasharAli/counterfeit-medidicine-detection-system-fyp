...
const Drawer = ({ isOpen, onClose, distributerData }) => {
                ...
                <section className="absolute inset-y-0 right-0 pl-10 max-w-full flex sm:pl-16 outline-none">
                    <div className="w-screen max-w-lg">
                        <div className="h-full flex flex-col bg-white shadow-xl overflow-y-scroll">
                            ...
                            <div className="p-4">
                                {distributerData ? distributerData.map((data) => (
                                    <div key={data._id} className="mb-4 p-4 border rounded">
                                        <p>Manufacturer Name: {data.manufacturername}</p>
                                        <p>GLN: {data.gln}</p>
                                        <p>GTIN: {data.gtin}</p>
                                        <p>SSCC: {data.sscc}</p>
                                        <p>GRAI: {data.grai}</p>
